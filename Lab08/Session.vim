...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/molokai,~/.vim/bundle/vim-better-whitespace,~/.vim/bundle/vim-indent-guides,~/.vim/bundle/indentline,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/molokai/after,~/.vim/bundle/vim-better-whitespace/after,~/.vim/bundle/vim-indent-guides/after,~/.vim/bundle/indentline/after
set shiftround
set shiftwidth=4
set showcmd
set softtabstop=4
...
12
normal! 073|
tabedit ../driver/inc/f3d_nunchuk.h
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
