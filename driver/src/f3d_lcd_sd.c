...
void f3d_lcd_sd_interface_init(void) {
    ...
    GPIO_InitTypeDef GPIO_AF_InitStruct;
    GPIO_StructInit(&GPIO_AF_InitStruct);
    GPIO_AF_InitStruct.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15;
    GPIO_AF_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_AF_InitStruct.GPIO_Mode = GPIO_Mode_AF;
    GPIO_AF_InitStruct.GPIO_OType = GPIO_OType_PP;
    GPIO_AF_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_Init(GPIOB, &GPIO_AF_InitStruct);
